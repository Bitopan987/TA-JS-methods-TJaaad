...
// }
// final = fruits.forEach(myFunction);
// console.log(final);
...
let newFlateArray = numbersThree.flat(Infinity);
console.log(newFlateArray);
// Use forEach to log all the elements of numberThree array

newFlateArray.forEach((num) => console.log(num));

// Create a new variable named doubleNumbers that store the numberThree array (each element should be multiplied by 2). Use map

let doubleNumbers = newFlateArray.map((num) => num * 2);
console.log(doubleNumbers);
// Create a new variable named tripleNumbers that store the numberThree array (each element should be multiplied by 3). Use map
let tripleNumbers = newFlateArray.map((num) => num * 3);
console.log(tripleNumbers);
// Create a new variable named halfNumbers that store the numberThree array (each element should be divided by 2). Use map
function halfNum(num) {
  return num / 2;
}
halfNumbers = newFlateArray.map(halfNum);
console.log(halfNumbers);
// Create a new variable named oddNumbers that store all the odd numbers in numbersThree array
function oddNum(num) {
  return num % 2 !== 0;
}
oddNumbers = newFlateArray.filter(oddNum);
console.log(oddNumbers);
// Create a new variable named evenNumbers that store all the even numbers in numbersThree array
function evenNum(num) {
  return num % 2 === 0;
}
evenNumbers = newFlateArray.filter(evenNum);
console.log(evenNumbers);
// Find the index of 10 in numbersThree array
console.log(newFlateArray.indexOf(10));
// Reverse the values of numbersThree array
console.log(newFlateArray.reverse());
// Reverse the values of numbersTwo array
console.log(numbersTwo.reverse());
// Join all fruits with '-', convert to uppercase and log it
console.log(fruits.join("-").toUpperCase());
// let finalFruit = fruits.join("-");
// result = finalFruit.toUpperCase();
// console.log(result);
